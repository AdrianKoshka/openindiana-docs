...
For help writing this section, see the following:
...
Write about the share manager command - `sharemgr`.

.For a variation of this....could be done virtually as well
...
==== Configuring OpenIndiana as an ISCSI Target Server
