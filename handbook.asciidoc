...
* `pkg update -nv` for a dry run (lists the changes which will be made to the system)
* `pkg update` for the actual update itself
* `pkg history` for a list of the changes which were made
