...
[NOTE]
====
Click to view this doc in its final Asciidoctor rendered form: http://gist.asciidoctor.org/?b5010389c24aa5160ffa
====
...
Another consideration is printing. There should be printer friendly CSS used with the HTML pages. 
