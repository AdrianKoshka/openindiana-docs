...
To add a repository, use the following command: `pkg set-publisher -G "*" -g repository_url repository_name`
...
An effort currently exists within the OpenIndiana community to update and consolidate these titles to match current development of OpenIndiana Hipster.
