...
| http://openindiana.org/download[Primary Download Site] 
| http://wiki.openindiana.org/oi/Mirrors[Additional Mirrors]
|===
...
* While upgrading from oi-dev-151x is possible, the most trouble free method is to perform a clean install.
====
...
== Is there support additional keyboard layouts and languages?
